...
import html
import pickle
# URL = 'https://plato.stanford.edu/contents/{}'format(title)
# r = requests.get('https://plato.stanford.edu/contents.html')
# content = r.text
# pickle.dump(content, open('sep_dict.pickle', 'wb'))
...
# Major content formatting begins here:
...
# Final organization step before 'group' items are appended to 'working_content':
final_dict = {}
